...
<ul class="list-inline">
    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            ...
            <div class="box box-default">
                ...
                <div class="box-header with-border">
                  <h3 class="box-title"><i class="glyphicon glyphicon-plus-sign"></i> 保育所特長の登録</h3>
        ...
        <div class="box-body" style="padding: 30px;">
            ...
            {!! Form::open(['route' => 'admin_concepts.store', 'files' => true]) !!}
                <div class="form-group">
                    {!! Form::label('title', 'タイトル', [ 'class' => 'required', ]) !!}
                    {!! Form::text('title', old('title'),  ['class' => 'form-control', 'placeholder' => '記入例：1日４時間からの短時間勤務が可能！']) !!}
                </div>
                <div class="form-group">
                    {!! Form::label('content_concept', '特長') !!}
                    {!! Form::textarea('content_concept', old('content_concept'),  ['class' => 'form-control']) !!}
                </div>
